 ...
 * @access public
 */
class Business_Responsiveness_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * Business_Responsiveness_Customizer_Range_Value_Control constructor.
	 *
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/functions/customizer/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ) , '1.5.4', true );
		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/functions/customizer/customizer-range-value/css/customizer-range-value-control.css',array(), '1.5.4' );
	}
 ...
 */
function Business_Responsiveness_sanitize_range_value( $input ) {
	if ( Business_Responsiveness_json( $input ) ) {
