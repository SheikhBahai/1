...
if( !function_exists('snappy_category_widgets') ):
     ...
     * @since 1.0.0
     */
    function snappy_category_widgets(){

        // Recent Post widget.
        register_widget('Snappy_Sidebar_Category_Widget');

    }

endif;

add_action('widgets_init', 'snappy_category_widgets');

// Recent Post widget
if( !class_exists('Snappy_Sidebar_Category_Widget') ):
     ...
     * @since 1.0.0
     */
    class Snappy_Sidebar_Category_Widget extends Snappy_Widget_Base{
        ...
        function __construct(){
            ...
            $opts = array(
                'classname' => 'snappy_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'snappy'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'snappy'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'snappy'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_title' => array(
                    'label' => esc_html__('Latest Text Label:', 'snappy'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Latest :', 'snappy'),
                ),
            );

            parent::__construct('snappy-category-layout', esc_html__('Snappy: Sidebar Category Widget', 'snappy'), $opts, array(), $fields);
        }
