...
function FT_OP_options()
{
	...
	$options[] = array( "name" => "Featured posts",
						"desc" => "Select the category for featured posts",
						"id" => "fabthemes_feat_cat",
						"type" => "select",
						"options" => $options_categories);	

	$options[] = array( "name" => "Number of featured posts",
						"desc" => "Enter number of featured posts on homepage.",
						"id" => "fabthemes_featcount",
						"std" => "5",
						"type" => "text");												
