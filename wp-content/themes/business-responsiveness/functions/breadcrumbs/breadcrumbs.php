<?php
if( !function_exists('$Business_Responsiveness_breadcrumbs') ):
	function Business_Responsiveness_breadcrumbs() { 
	...
	<div class="rdn-sub-header-inner">
		<ul>
			<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php _e('Home','business-responsiveness' ); ?></a></li>
			<?php 
			...
			if (is_home() || is_front_page()) :
				...
				elseif( is_404() ){
					echo '<li>' . __('404 Error','business-responsiveness' ) . '</li>';
				}
				else { 
					the_title('<li>','</li>'); 
				}
