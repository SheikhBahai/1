...
/**
 * Class Business_Responsiveness_Customizer_Theme_Info_Main
 *
 * @since  1.0.0
 * @access public
 */
class Business_Responsiveness_Customizer_Theme_Info_Main extends WP_Customize_Section {
	 ...
	 * @var    string
	 */
	public $type = 'business-theme-info';
