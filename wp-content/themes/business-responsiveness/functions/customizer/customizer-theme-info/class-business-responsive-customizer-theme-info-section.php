...
$define_classs = class_exists( 'WP_Customize_Control' ) && $display_upsells === true && ! class_exists( 'Business_Responsiveness_Customizer_Theme_Info_Section' );
if ( $define_classs ) :
	/**
	 * Class bangalorethemes_Section_Upsell
	 */
	class Business_Responsiveness_Customizer_Theme_Info_Section extends WP_Customize_Section {
		...
		/**
		 * Business_Responsiveness_Customizer_Theme_Info_Section constructor.
		 */
		...
		?>
			<div class="bangalorethemes-upsell bangalorethemes-boxed-section">
