<?php 
function business_resonsive_page_menu_args( $args ) {
	if ( ! isset( $args['show_home'] ) )
		$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'business_resonsive_page_menu_args' );

 
function Business_Responsiveness_fallback_page_menu( $args = array() ) {
	...
	$list_args['title_li'] = '';
	$list_args['walker'] = new Business_Responsiveness_walker_page_menu;
...
class Business_Responsiveness_walker_page_menu extends Walker_Page{
