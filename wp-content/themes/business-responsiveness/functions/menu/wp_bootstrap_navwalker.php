...
/**
 * Class Name: Business_Responsiveness_bootstrap_navwalker
 ...
 *
 * @since Business Responsive 1.0
 */

class Business_Responsiveness_bootstrap_navwalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$atts = array();
            ...
            } elseif( in_array( 'business-mm-heading', $item->classes ) && ( $item->url === '#' ) ) {
            	$item_output .= '<span class="mm-heading-wrapper">';
            } elseif( in_array( 'business-mm-heading', $item->classes ) ) {
			...
			if( ! empty( $item->description ) && ( $item->description !== ' ' ) && $depth >= 1 ) {
				$item_output .= '<li class="business-mm-description">' . $item->description;
			}
