		...
		<div class="rdn-section-body">
			<div class="container">
				...
				<div class="row">
					...
					<h1 class="section-title wow animated fadeInUp"><?php echo wp_kses_post( $option['news_section_title'] ); ?></h1>
					<?php endif; ?>
					<?php if($option['news_section_description']!=''): ?>
					<p class="section-desc wow animated fadeInUp"><?php echo wp_kses_post( $option['news_section_description'] ); ?></p>
					<?php endif; ?>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6">
						<div class="media rdn-home-news-area">
							...
							<div class="media-body home-news-body text-center">
