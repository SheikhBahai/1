...
if (!function_exists('newsever_get_breadcrumb')) :
    ...
    function newsever_get_breadcrumb()
    {
        ...
        $select_breadcrumbs = newsever_get_option('select_breadcrumb_mode');
...
/* Display Breadcrumbs */
if (!function_exists('newsever_get_breadcrumb_trail')) :
    ...
    function newsever_get_breadcrumb_trail()
    {
