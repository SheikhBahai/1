(function ($) {
  ...
  var ajaxurl = snappy_admin.ajax_url;
  var snappyNonce = snappy_admin.ajax_nonce;
  ...
  $('.twp-custom-setup').click(function(){
      ...
      var data = {
          'action': 'snappy_notice_dismiss',
          '_wpnonce': snappyNonce,
      };

      $.post(ajaxurl, data, function( response ) {

          $('.twp-snappy-notice').hide();
  ...
  $('.twp-install-active').click(function(){
      ...
      $(this).closest('.twp-snappy-notice').addClass('twp-installing');

      var data = {
          'action': 'snappy_install_plugins',
          '_wpnonce': snappyNonce,
      };
  ...
  $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
      ...
      $.post(ajaxurl, data, function( response ) {
          ...
          var active = snappy_admin.active
          var deactivate = snappy_admin.deactivate
