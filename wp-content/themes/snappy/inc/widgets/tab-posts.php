...
if ( !function_exists('snappy_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function snappy_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Snappy_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'snappy_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Snappy_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Snappy_Tab_Posts_Widget extends Snappy_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'snappy_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'snappy'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'snappy'),
                    'type'           => 'heading',
                ),
                'popular_title' => array(
                    'label' => esc_html__('Popular Tab Title', 'snappy'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'snappy'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'snappy'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'snappy'),
                    'type'              => 'checkbox',
                    'default'           => false,
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'snappy'),
                    'description'   => esc_html__('Number of words', 'snappy'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'snappy'),
                    'type'          => 'heading',
                ),
                'recent_title' => array(
                    'label' => esc_html__('Recent Tab Title', 'snappy'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'snappy'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'snappy'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'snappy'),
                    'type'            => 'heading',
                ),
                'comment_title' => array(
                    'label' => esc_html__('Comment Tab Title', 'snappy'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'snappy'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'snappy'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'snappy-tabbed', esc_html__( 'Snappy: Tab Posts Widget', 'snappy' ), $opts, array(), $fields );
                                ...
                                <div class="column-row column-row-small">
                                    ...
                                    <div class="column column-4">
                                        <div class="article-image">
                                            ...
                                            <a href="<?php the_permalink();?>" class="data-bg data-bg-thumbnail" data-background="<?php echo esc_url( $image[0] ); ?>"></a>
