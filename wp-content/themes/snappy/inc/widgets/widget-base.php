 ...
 * @since 1.0.0
 */
class Snappy_Widget_Base extends WP_Widget {
    /**
     * Fields.
     *
     * @since 1.0.0
        ...
        switch ( $field_type ) {
            ...
            case 'image':
                ...
                <div>
                    ...
                    <!-- <br /> -->
                    <input type="button" class="twp-select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'snappy' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'snappy' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'snappy' ); ?>" />
                    <?php
                    $image_status = false;
                    if ( ! empty( $value ) ) {
                        $image_status = true;
                    ...
                    ?>
                    <input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'snappy' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
